...
export function PosPage(){
  ...
  return(
    <div>
      ...
      <div className='font-body bg-input min-h-screen pb-2 ml-18 pl-5 pt-36 overflow-hidden pr-10 py-1.75 w-[66.6%]'>
        <div className='w-full grid w-purple-400 grid-cols-4 align-middle justify-between gap-x-7 gap-y-2'>

          {menuItems.map((items)=>{
            return(
              <div key={items.itemId} category={items.itemCategory} className='bg-white hover:border-secondary scale-100 active:scale-95 cursor-pointer flex flex-col p-3 w-card transition-transform duration-100 hover:-translate-y-0.5 gap-1 border border-border rounded-lg'>
