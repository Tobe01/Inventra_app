    ...
    <>
      ...
      <div className="font-body bg-dark z-105 fixed left-0 top-0 bottom-0 flex flex-col align-middle justify-between py-5 px-4">
        <div className="flex flex-col align-middle justify-center space-y-5">
          <button className="text-white bg-secondary font-bold text-20 rounded-md text-center justify-items-center w-9 ml-auto mr-auto py-1 cursor-pointer">
            SF
          </button>
        ...
        <div className="flex flex-col align-middle justify-center space-y-1">
          <button onClick={renderLogout} className="text-center scale-100 active:scale-110 group relative justify-items-center  hover:bg-neutral-700 rounded-md py-2.5 px-2.5 cursor-pointer">
