...
export function Mainnav(){
  return(
    <div className='font-body bg-dark z-60 fixed left-0 top-0 bottom-0 flex flex-col align-middle justify-between py-5 px-4'>
      ...
      <div className='flex flex-col align-middle justify-center space-y-1'>
        ...
        <button className='text-center scale-100 active:scale-110 group relative justify-items-center  hover:bg-neutral-700 rounded-md py-2.5 px-2.5 cursor-pointer'>
        ...
        <button className='text-white scale-100 active:scale-110 group relative font-bold bg-neutral-700 rounded-md text-center justify-items-center py-2 px-2.5 cursor-pointer'>AO <span className='absolute pointer-events-none opacity-0 group-hover:opacity-100 duration-200 -right-22 bottom-1 bg-dark text-white text-sm w-18 p-1 m-auto text-center rounded-md'>Ada Obi</span></button>
