  ...
  return(
    <div className="w-[71.9%] z-50 font-body bg-white flex align-middle fixed top-20 left-0 right-0 justify-start pl-23 py-1.75 border border-border border-x-0 border-t-0">
      <div className="flex gap-2">
        <button className="scale-100 bg-secondary transition-transform duration-100 active:scale-105 cursor-pointer hover:border-secondary p-2 px-4 text-white border border-border rounded-lg">All</button>
